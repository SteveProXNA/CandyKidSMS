M:cont_screen
F:G$screen_cont_screen_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_cont_screen_update$0$0({2}DF,SV:S),Z,0,3,0,0,0
S:Lcont_screen.screen_cont_screen_update$screen_type$1$79({2}DG,SC:U),B,1,4
...
S:Fcont_screen$event_stage$0$0({1}SC:U),E,0,0
S:Fcont_screen$cursor$0$0({1}SC:U),E,0,0
