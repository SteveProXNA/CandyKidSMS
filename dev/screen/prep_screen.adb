M:prep_screen
F:G$screen_prep_screen_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lprep_screen.screen_prep_screen_load$st$1$84({2}DG,STtag_struct_state_object:S),R,0,0,[]
S:Lprep_screen.screen_prep_screen_load$lo$1$84({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lprep_screen.screen_prep_screen_load$ho$1$84({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lprep_screen.screen_prep_screen_load$oneup_count$1$84({1}SC:U),R,0,0,[b]
F:G$screen_prep_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lprep_screen.screen_prep_screen_update$screen_type$1$87({2}DG,SC:U),B,1,4
S:Lprep_screen.screen_prep_screen_update$st$1$88({2}DG,STtag_struct_state_object:S),R,0,0,[]
S:Lprep_screen.screen_prep_screen_update$delay$1$88({1}SC:U),R,0,0,[c]
S:Lprep_screen.screen_prep_screen_update$input$1$88({1}SC:U),R,0,0,[l]
S:Lprep_screen.screen_prep_screen_update$index$1$88({1}SC:U),R,0,0,[l]
S:Lprep_screen.screen_prep_screen_update$gamer_collision$1$88({1}SC:U),R,0,0,[]
F:Fprep_screen$setup_level$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lprep_screen.setup_level$tile_type$1$90({1}SC:U),B,1,4
S:Lprep_screen.setup_level$go$1$91({2}DG,STtag_struct_gamer_object:S),R,0,0,[]
S:Lprep_screen.setup_level$bo$1$91({2}DG,STtag_struct_boss_object:S),R,0,0,[e,d]
S:Lprep_screen.setup_level$bossX$1$91({1}SC:U),R,0,0,[c]
F:Fprep_screen$print_level$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lprep_screen.print_level$st$1$95({2}DG,STtag_struct_state_object:S),R,0,0,[]
S:Lprep_screen.print_level$index$1$95({1}SC:U),B,1,-1
T:Fprep_screen$tag_struct_hack_object[({0}S:S$hack_object_delay_test$0$0({1}SC:U),Z,0,0)({1}S:S$hack_object_mydebugger$0$0({1}SC:U),Z,0,0)({2}S:S$hack_object_invincibie$0$0({1}SC:U),Z,0,0)({3}S:S$hack_object_full_boost$0$0({1}SC:U),Z,0,0)({4}S:S$hack_object_trees_type$0$0({1}SC:U),Z,0,0)({5}S:S$hack_object_exits_type$0$0({1}SC:U),Z,0,0)({6}S:S$hack_object_difficulty$0$0({1}SC:U),Z,0,0)({7}S:S$hack_object_pace_speed$0$0({1}SC:U),Z,0,0)({8}S:S$hack_object_world_data$0$0({1}SC:U),Z,0,0)({9}S:S$hack_object_round_data$0$0({1}SC:U),Z,0,0)({10}S:S$hack_object_music_data$0$0({1}SC:U),Z,0,0)({11}S:S$hack_object_sound_data$0$0({1}SC:U),Z,0,0)({12}S:S$hack_object_enemy_move$0$0({3}DA3d,SC:U),Z,0,0)]
T:Fprep_screen$tag_struct_boss_object[({0}S:S$actor$0$0({1}SC:U),Z,0,0)({1}S:S$posnX$0$0({1}SC:U),Z,0,0)({2}S:S$posnY$0$0({1}SC:U),Z,0,0)({3}S:S$homeX$0$0({1}SC:U),Z,0,0)({4}S:S$homeY$0$0({1}SC:U),Z,0,0)({5}S:S$tileX$0$0({1}SC:U),Z,0,0)({6}S:S$tileY$0$0({1}SC:U),Z,0,0)({7}S:S$tileZ$0$0({1}SC:U),Z,0,0)({8}S:S$waiter$0$0({1}SC:U),Z,0,0)({9}S:S$action$0$0({1}SC:U),Z,0,0)({10}S:S$scatter$0$0({8}DA8d,SC:U),Z,0,0)({18}S:S$paths$0$0({1}SC:U),Z,0,0)({19}S:S$speed$0$0({1}SC:U),Z,0,0)({20}S:S$delay$0$0({1}SC:U),Z,0,0)({21}S:S$timer$0$0({1}SC:U),Z,0,0)({22}S:S$total$0$0({1}SC:U),Z,0,0)({23}S:S$sizer$0$0({1}SC:U),Z,0,0)({24}S:S$mover$0$0({1}SC:U),Z,0,0)({25}S:S$drawr$0$0({1}SC:U),Z,0,0)({26}S:S$wide$0$0({1}SC:U),Z,0,0)({27}S:S$high$0$0({1}SC:U),Z,0,0)({28}S:S$lifecycle$0$0({1}SC:U),Z,0,0)({29}S:S$prev_move$0$0({1}SC:U),Z,0,0)({30}S:S$direction$0$0({1}SC:U),Z,0,0)({31}S:S$image$0$0({1}SC:U),Z,0,0)]
T:Fprep_screen$tag_struct_frame_object[({0}S:S$frame_count$0$0({2}SI:U),Z,0,0)]
T:Fprep_screen$tag_struct_gamer_object[({0}S:S$posnX$0$0({1}SC:U),Z,0,0)({1}S:S$posnY$0$0({1}SC:U),Z,0,0)({2}S:S$tileX$0$0({1}SC:U),Z,0,0)({3}S:S$tileY$0$0({1}SC:U),Z,0,0)({4}S:S$tileZ$0$0({1}SC:U),Z,0,0)({5}S:S$curr_boost$0$0({1}SC:U),Z,0,0)({6}S:S$prev_boost$0$0({1}SC:U),Z,0,0)({7}S:S$speeds$0$0({2}DA2d,SC:U),Z,0,0)({9}S:S$delays$0$0({2}DA2d,SC:U),Z,0,0)({11}S:S$speed$0$0({1}SC:U),Z,0,0)({12}S:S$delay$0$0({1}SC:U),Z,0,0)({13}S:S$timer$0$0({1}SC:U),Z,0,0)({14}S:S$delta$0$0({1}SC:U),Z,0,0)({15}S:S$total$0$0({1}SC:U),Z,0,0)({16}S:S$prev_move$0$0({1}SC:U),Z,0,0)({17}S:S$direction$0$0({1}SC:U),Z,0,0)({18}S:S$lifecycle$0$0({1}SC:U),Z,0,0)({19}S:S$image$0$0({1}SC:U),Z,0,0)({20}S:S$frame$0$0({1}SC:U),Z,0,0)({21}S:S$calcd$0$0({2}SI:U),Z,0,0)({23}S:S$images$0$0({6}DA3d,DA2d,SC:U),Z,0,0)]
T:Fprep_screen$tag_struct_delay_object[({0}S:S$delay_value$0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0$0({2}SI:U),Z,0,0)]
T:Fprep_screen$tag_struct_level_object[({0}S:S$level_object_bonus_count$0$0({1}SC:U),Z,0,0)({1}S:S$level_object_candy_count$0$0({1}SC:U),Z,0,0)({2}S:S$level_object_oneup_count$0$0({1}SC:U),Z,0,0)({3}S:S$level_object_multiplier$0$0({1}SC:U),Z,0,0)]
T:Fprep_screen$tag_struct_score_object[({0}S:S$score$0$0({2}SI:U),Z,0,0)({2}S:S$values$0$0({5}DA5d,SC:U),Z,0,0)({7}S:S$bonus$0$0({1}SC:U),Z,0,0)({8}S:S$candy$0$0({1}SC:U),Z,0,0)({9}S:S$oneup$0$0({1}SC:U),Z,0,0)]
T:Fprep_screen$tag_struct_state_object[({0}S:S$state_object_availables$0$0({1}SC:U),Z,0,0)({1}S:S$state_object_localcheat$0$0({1}SC:U),Z,0,0)({2}S:S$state_object_high_score$0$0({2}SI:U),Z,0,0)({4}S:S$state_object_trees_type$0$0({1}SC:U),Z,0,0)({5}S:S$state_object_exits_type$0$0({1}SC:U),Z,0,0)({6}S:S$state_object_difficulty$0$0({1}SC:U),Z,0,0)({7}S:S$state_object_pace_speed$0$0({1}SC:U),Z,0,0)({8}S:S$state_object_world_data$0$0({1}SC:U),Z,0,0)({9}S:S$state_object_round_data$0$0({1}SC:U),Z,0,0)({10}S:S$state_object_actor_kill$0$0({1}SC:U),Z,0,0)({11}S:S$state_object_fight_type$0$0({1}SC:U),Z,0,0)({12}S:S$state_object_curr_screen$0$0({1}SC:U),Z,0,0)({13}S:S$state_object_next_screen$0$0({1}SC:U),Z,0,0)]
T:Fprep_screen$tag_struct_reset_object[({0}S:S$reset_value$0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0$0({1}SC:U),Z,0,0)]
